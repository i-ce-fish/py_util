        ...
        <el-card class="box-card">
            ...
            >
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="产品id:" prop="good_id">
                    ...
                    <el-col :span="12">
                        <el-form-item label="所属订单:" prop="goodorder_id">
                    ...
                    <el-col :span="24">
                        <el-form-item>
                            <el-button @click="submit('orderitemForm')">提交</el-button>
...
<script>
    ...
    export default {
        ...
        methods: {
            async getOrderitem() {
                const res = await getOrderitem(this.$route.query.id)
                this.orderitemForm = res.data
            },

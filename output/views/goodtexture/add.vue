        ...
        <el-card class="box-card">
            ...
            >
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item
                            label="材质纤维大类别名:" prop="texture_alias"
                    ...
                    <el-col :span="12">
                        <el-form-item
                            label="是否需要填写成分含量:" prop="filled_content"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async submit() {
                this.$refs.goodtextureForm.check((valid) => {
                    if (valid) {
                        this.addGoodtexture()
                    }
                })

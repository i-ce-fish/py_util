        ...
        <el-card class="box-card">
            ...
            >
                <el-row :gutter="20">
                    ...
                    <el-col :span="12">
                        <el-form-item
                            label="商家靠谱度:" prop="good_reliable"
                    ...
                    <el-col :span="12">
                        <el-form-item
                            label="货品靠谱度:" prop="merchant_reliable"
